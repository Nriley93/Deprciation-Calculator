...
public class DepCalcView extends FrameView {
    ...
    private void initComponents() {
        ...
        depCalcApp1 = new depcalc.DepCalcApp();
    ...
    private void jbtnCalcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnCalcActionPerformed
        ...
        if(jtxtAssetNm.getText().isEmpty()) {
            statusMessageLabel.setText("Please enter asset description");
        ...
        a = new Asset(jtxtAssetNm.getText(), c, s, lf);
        ...
        String[][] t = new String[a.getLife()][4];
        ...
        jtblSched.setDefaultRenderer(Object.class, rightRenderer);
        
        for(int i = 1; i <= a.getLife(); i++){
            jtblSched.setValueAt(i, (i-1), 0);
            jtblSched.setValueAt(
                     currency.format(a.getBegBal(i, m)) , (i-1), 1);
            if(m.equalsIgnoreCase("S")){
                jtblSched.setValueAt(
                          currency.format(a.getAnnDep()), (i-1), 2);
            } else {
                jtblSched.setValueAt(
                        currency.format(a.getAnnDep(i)), (i-1), 2);
            }
            jtblSched.setValueAt(
                    currency.format(a.getEndBal(i, m)), (i-1), 3);
            jtblSched.getColumnModel().getColumn(0).setCellRenderer(centerRenderer);
        }
    ...
    private void jbtnClearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnClearActionPerformed
        ...
        DefaultTableModel mod = new DefaultTableModel(0, 0);
        jtblSched.setModel(mod);
    }//GEN-LAST:event_jbtnClearActionPerformed

    private void jmnuSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jmnuSaveActionPerformed

        String save = jtxtAssetNm.getText().concat("\n") +
                jtxtCost.getText().concat("\n") +
                jtxtSalvage.getText().concat("\n") +
                jtxtLife.getText();

         JFileChooser savefile = new JFileChooser();
         int sf = savefile.showSaveDialog(null);
         
         Asset.setSave(savefile, save);
//                
...
//                filename += ".txt";
    ...
    private depcalc.DepCalcApp depCalcApp1;
